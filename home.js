...
let newDeals = deals[0]
newDeals = newDeals.title.replace(`15`, `10`)
...
let secondDeal = deals[1]
secondDeal = secondDeal.desc.replace(`March`, `April`)
secondDeal = secondDeal.trim()
